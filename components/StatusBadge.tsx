export default function StatusBadge({ children }: { children: string }) {
  ...
  return <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-bold ${positive ? "bg-emerald-50 text-emerald-700" : warning ? "bg-amber-50 text-amber-700" : "bg-blue-50 text-blue-700"}`}>{children}</span>;
}
